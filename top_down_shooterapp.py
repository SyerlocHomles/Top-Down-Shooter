...
<div style="text-align:center; background:#111; padding:15px; border-radius:15px; border: 4px solid #444; position:relative; font-family: sans-serif; user-select: none;">
    ...
    <div id="upgrade-menu" style="display:none; position:absolute; top:10px; left:50%; transform:translateX(-50%); background:rgba(25,25,25,0.98); padding:15px; border:3px solid #ffd700; border-radius:12px; width:85%; z-index:100; box-shadow: 0 5px 20px rgba(0,0,0,0.8);">
        <h3 style="color:#ffd700; margin:0 0 10px 0; font-size:14px;">LEVEL UP! PILIH UPGRADE:</h3>
        <div style="display:flex; gap:8px; justify-content:center;">
            <button onclick="applyUpgrade('speed')" style="flex:1; padding:10px 2px; background:#4deaff; border:none; border-radius:5px; font-weight:bold; cursor:pointer; font-size:11px;">⚡ SPEED +0.5</button>
            <button onclick="applyUpgrade('flank')" style="flex:1; padding:10px 2px; background:#ff4d4d; border:none; border-radius:5px; font-weight:bold; cursor:pointer; font-size:11px;">🛡️ FLANK GUARD</button>
            <button onclick="applyUpgrade('pet')" style="flex:1; padding:10px 2px; background:#ffff4d; border:none; border-radius:5px; font-weight:bold; cursor:pointer; font-size:11px;">🤖 DRONE PET</button>
        </div>
    </div>
